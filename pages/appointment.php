...
<?php nav()?>
  <div class="container-fluid  d-flex justify-content-center align-items-center flex-column appointment p-5">
    <h2>SHEDULE APPOINTMENT FREE WITH CONVENIENCE</h2>
    <p class="m-2 text-center text-white">
      If you want to book an appointment Please, fill out this form .Once you filled form than you will receive
      confirmation call and email.We are available 9:00AM to 6:00PM Monday through Saturday.
    </p>
  </div>

  <div class="col font-white d-flex justify-content-center align-items-center flex-column font-size-sm p-5 m-5"
    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
    <form class="row g-2 needs-validation" method="POST" action="appointment.php">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="input-group has-validation">
          ...
          <select class=" chosen-select form-select form-custom " style=" background-color: transparent" id="aservices" data-placeholder="choose services" multiple  name="aservices" required>
          <option value=""></option>
    ...
    <option>logbook Servicing</option>
      ...
      <div class="form-check">
        <input class="form-check-input" type="checkbox"  id="pick-car" onclick="pick()" name="aselection">
      ...
      <div class="col">
            ...
            <div class="alert alert-light alert-dismissible fade show">
              ...
              <p>we will responded you with in hour.</p>
            </div>
            <?php }?>
        </div>
    </form>
